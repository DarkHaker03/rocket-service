...
namespace Data.Migrations
{
    ...
    [Migration("20240131083213_UserImage")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.UwProductWaste", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WasteBillId");

                    b.ToTable("uw_product_waste");
                });
            ...
            modelBuilder.Entity("Domain.Entities.UwProductWaste", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.UwWasteBill", "WasteBill")
                        .WithMany("ProductsWaste")
                        .HasForeignKey("WasteBillId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ReceivedProduct");

                    b.Navigation("WasteBill");
                });

            modelBuilder.Entity("Domain.Entities.UwProductWay", b =>
                {
                    b.HasOne("Domain.Entities.UwProductWay", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
