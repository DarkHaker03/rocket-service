...
namespace Data.Migrations
{
    ...
    [Migration("20240201065412_Bills")]
    partial class Bills
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.UwBill", b =>
                {
                    ...
                    b.Property<Guid?>("UwProductStageId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.UwBill", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.UwProductStage", null)
                        .WithMany("WasteBills")
                        .HasForeignKey("UwProductStageId");
